    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid bg-white col-6" style="float: left; margin-left: 50px; padding-top: 50px; padding-bottom: 50px;">
                <h1>Add Questions to Survey: {{ $data->title }}</h1>
                <div class="col-xl-11 col-md-11 mb-10">
                    <form method="POST" action="">
                        ...
                        <div class="form-group" id="question-container">
                            ...
                            <input type="text" class="form-control" id="survey_id" name="survey_id" value="{{ $data->id }}">
                            <input type="text" class="form-control" id="question" name="questions[]" placeholder="survey title">
                        </div>
